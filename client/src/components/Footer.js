    ...
    <footer>
      <Container fluid className=' my-5'>
        <Row className='mx-5 px-5'>
          <Col md={4}>
            <h3>Blockchain Pizza Shop</h3>
            <p className='text-justify'>
         Great Pizza in a decentralized environememnt safe to eat safe to place order.
            </p>
          </Col>
          <Col md={3}>
        ...
        <Row>
          <Col className='text-center pt-3 mt-5'>
            Copyright &copy; BLockchain Pizza Shop <br />
            BLockchain Team All rights reserved
          </Col>
        </Row>
      </Container>
    </footer>
